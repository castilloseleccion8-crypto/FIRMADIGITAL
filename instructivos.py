...
INSTRUCTIVOS = {
    "SIN_SOLICITUD": {
        ...
        "pasos": [
            ...
            "En el campo \"Password\" pegá tu Contraseña ENCODE (pedísela a RRHH si no la tenés) y hacé click en \"Registrar\".",
            ...
            "En \"Crear PIN de Seguridad\" ingresá tu PIN (pedíselo a RRHH si no lo tenés) y tildá \"Información importante sobre tu PIN\".",
    ...
    "PENDIENTE_DESCARGA": {
        ...
        "pasos": [
            ...
            "Ingresá con usuario (tu CUIL) y tu Contraseña ENCODE (pedísela a RRHH si no la tenés) y hacé click en \"Iniciar sesión\".",
